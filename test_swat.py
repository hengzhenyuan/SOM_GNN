...
# Load the graph data
with open('swat_graphdata.pkl', 'rb') as file:
...
with open('SWATgraph_results_5.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['Epoch', 'Graph Precision', 'Graph Recall', 'Graph F1'])

with open('SWATnode_results_5.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
...
for epoch in range(100):
    ...
    with open('SWATgraph_results_5.csv', mode='a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([epoch + 1, graph_precision, graph_recall, graph_f1])

    # Append the node results to the node CSV file
    with open('SWATnode_results_5.csv', mode='a', newline='') as file:
        writer = csv.writer(file)
